...
/* harmony export */   "renderAboutGame": function() { return /* binding */ renderAboutGame; }
/* harmony export */ });
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings */ "./js/modules/settings.js");

const main = document.querySelector('main'); // about Game
...
function renderAboutGame() {
  ...
  aboutGame.innerHTML = `<h1 class="title">How to play?</h1>
        <div class="content">
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "renderBestScore": function() { return /* binding */ renderBestScore; }
/* harmony export */ });
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings */ "./js/modules/settings.js");
/* harmony import */ var _indexDB__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./indexDB */ "./js/modules/indexDB.js");


const main = document.querySelector('main'); // Best score
...
class Game {
  ...
  tougleBtnStartStopGame() {
    ...
    switch (btnStartStop.textContent) {
      case 'start game':
        btnStartStop.textContent = 'stop game';
        break;

      case 'stop game':
        btnStartStop.textContent = 'start game';
        break;
    }
  }
...
/* harmony export */   "checkUserInDB": function() { return /* binding */ checkUserInDB; },
/* harmony export */   "createUsersInBestScore": function() { return /* binding */ createUsersInBestScore; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "removeNavActive": function() { return /* binding */ removeNavActive; }
/* harmony export */ });
...
function menu() {
  ...
  function renderPage(namePage) {
    switch (namePage) {
      case 'about_game':
        (0,_aboutGame__WEBPACK_IMPORTED_MODULE_0__.renderAboutGame)();
        break;

      case 'best_score':
        (0,_bestScore__WEBPACK_IMPORTED_MODULE_1__.renderBestScore)();
        break;

      case 'settings':
        (0,_settings__WEBPACK_IMPORTED_MODULE_2__.renderSettings)();
        break;
    }
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "renderModal": function() { return /* binding */ renderModal; },
  ...
  document.querySelector('.add_user_button').addEventListener('click', () => {
    ...
    btnStarStoptGame.addEventListener('click', () => {
      switch (btnStarStoptGame.textContent) {
        case 'start game':
          _classes__WEBPACK_IMPORTED_MODULE_0__.newGame.render();
          break;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "renderSettings": function() { return /* binding */ renderSettings; },
/* harmony export */   "delSettings": function() { return /* binding */ delSettings; }
/* harmony export */ });
/* harmony import */ var _classes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes */ "./js/modules/classes.js");

const body = document.querySelector('body'),
      main = document.querySelector('main'); // Settings
